...
class ONNXRuntimeAdapter(InferenceAdapter):
    ...
    generated by OpenVINO training extensions (OTX). Each onnx file
    generated by OTX contains ModelAPI-style metadata, which is used for
    configuring a particular model acting on top of it.
    Aslo, this adapter doesn't provide asynchronous inference fuctionality and model reshaping.
    Visit https://github.com/openvinotoolkit/training_extensions/ for the
